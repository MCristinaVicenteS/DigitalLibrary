...
namespace UniversalLibrary.Data
{
    public interface ILoanRepository : IGenericRepository<Loan>
    {
        ...
        //****método q devolve os dados temporários do Loan -> associa o Loan ao user -> LoanDetailTemp****
        //até confirmar os dados para a encomenda
        Task<IQueryable<LoanDetailTemp>> GetDetailTempAsync(string userName);
        ...
        //ou seja, passam da view create para a view index do controlador Loan
        ...
        Task AcceptLoan(FinishBookViewModel model);
